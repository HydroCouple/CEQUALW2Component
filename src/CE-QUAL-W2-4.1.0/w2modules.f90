...
MODULE RSTART
  ...
  REAL(R8)                                           :: ELTM
  REAL(R8),          ALLOCATABLE, DIMENSION(:)       :: VOLIN,  VOLOUT, VOLUH,  VOLDH,  VOLPR,  VOLTRB, &
  VOLDT, VOLWD,  VOLEV,VOLICE, ICEBANK
...
MODULE GLOBAL
  ...
  REAL,              ALLOCATABLE, DIMENSION(:)       :: TN_SEDSOD_NH4,TP_SEDSOD_PO4,TPOUT,TPTRIB,TPDTRIB,TPWD,&
  ...
  INTEGER                                            :: W2ERR,  WRN
  INTEGER(c_int), bind(C,NAME="GLOBAL_NWB")          :: NWB
  INTEGER(c_int), bind(C,NAME="GLOBAL_NBR")          :: NBR
  INTEGER(c_int), bind(C,NAME="GLOBAL_KMX")          :: KMX
  INTEGER(c_int), bind(C,NAME="GLOBAL_IMX")          :: IMX
  INTEGER(c_int), bind(C,NAME="GLOBAL_NTR")          :: NTR
  INTEGER(c_int), bind(C,NAME="GLOBAL_NST")          :: NST
  INTEGER(c_int), bind(C,NAME="GLOBAL_NWD")          :: NWD
  INTEGER                                            :: NCT,    NBOD
  INTEGER                                            :: NSP,    NGT,    NPI,    NPU,    NWDO,   NIKTSR, NUNIT
...
MODULE KINETIC
  ...
  INTEGER                                            :: nag,nagi
  LOGICAL                                            :: ammonia_buffering, phosphate_buffering, &
                                                        om_buffering, pom_buffering, pH_buffering, NONCON_ALKALINITY
...
MODULE GDAYC
  ...
  INTEGER(c_int), BIND(C, Name="GDAYC_YEAR")     :: OR_YEAR
  LOGICAL                                        :: LEAP_YEAR
  CHARACTER(9)                                   :: MONTH
END MODULE GDAYC
MODULE SCREENC
...
REAL, ALLOCATABLE, SAVE, DIMENSION (:) :: C_INT_V,C_TOP,CD_INT,CD_TOP,CN_E,CDN_E
...
! Variable declaration
  ...
  REAL          :: JDAYTS, JDAY1,HMAX, DLXMAX,CELRTY,NXTVD,TTIME
  REAL(c_double), BIND(C, NAME="MAIN_TMSTRT") :: TMSTRT
  REAL(c_double), BIND(C, NAME="MAIN_TMEND") :: TMEND
  ...
  LOGICAL       :: BRANCH_FOUND,       NEW_PAGE,        UPDATE_KINETICS, UPDATE_RATES
  LOGICAL(c_bool), BIND(C, NAME="MAIN_END_RUN") :: END_RUN
...
! Allocatable array declarations
  ...
  LOGICAL,       ALLOCATABLE, DIMENSION(:)     :: ISO_SEDIMENT1,   VERT_SEDIMENT1,  LONG_SEDIMENT1,ISO_SEDIMENT2,& 
                                                  VERT_SEDIMENT2,  LONG_SEDIMENT2  ! Amaila
  ...
  CHARACTER(72), ALLOCATABLE, DIMENSION(:)     :: SNPFN,  PRFFN,  VPLFN,  CPLFN,  SPRFN,  FLXFN,  &
                                                  FLXFN2, BTHFN,  VPRFN,  LPRFN, SPRVFN   ! SW 9/28/2018
...
Module CEMAVars
   ...
   ! Real(8), Allocatable, Dimension(:) :: sedcellwidth
    ...
    Integer(4) CEMAOutFilN1, CEMAOutFilN2, CEMAOutFilN3, CEMAOutFilN4, CEMAOutFilBub
