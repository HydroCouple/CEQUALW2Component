...
!!!!!!!!!!!!!!!!!!!!!!! debug
   If (CrackOpen(SegNumI)) Then
      ...
      MFTBubbReleased(SegNumI) = INT(NbubbLost)
      !nTry = 0
            ...
            Do nRelArr = 1, NumBubRelArr
               If (BubblesStatus(SegNumI, nRelArr) == 1 .and. BubblesAtSurface(SegNumI, nRelArr) .and. .NOT. ICE(SegNumI)) Then
                  ...
                  Do nGas = 1, NumGas
                     ...
                     BRVoluAGas(SegNumI, nRelArr, nGas) = BubblesReleaseAllValue(SegNumI, nRelArr)*TempBubblesRelVolume* &
                                                          BubblesGasConc(SegNumI, nRelArr, nGas)   !gm
                  ...
                  BubblesCarried(SegNumI, nRelArr) = BubblesCarried(SegNumI, nRelArr) - &
