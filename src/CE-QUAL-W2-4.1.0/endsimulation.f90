...
!***********************************************************************************************************************************
   ...
   IF (ERROR_OPEN) THEN
      ...
      WRITE (w2err, *) 'JDAY', jday, 'SZ', sz, 'Z', z, 'H2KT', h2(kt, 1:imx), 'H1KT', h1(kt, 1:imx), 'BHR1', &
         bhr1(kt, 1:imx), 'BHR2', bhr2(kt, 1:imx), 'WSE', elws, 'Q', q, 'QC', qc, 'QERR', qerr, 'T1', t1(kt, &
                         1:imx), 'T2', t2(kt, 1:imx), 'SUKT', su(kt, 1:imx), 'UKT', u(kt, 1:imx), 'QIN', qin, 'QTR', qtr, 'QWD', qwd
      close (w2err)
   ENDIF

   DEALLOCATE (LAYERCHANGE, TECPLOT, X1, HAB)
   DEALLOCATE (TSR, WDO, WDO2, ETSR, IWDO, ITSR, TITLE, CDAC, WSC, ESTR, WSTR, QSTR, KTSW, KBSW, &
               SINKC, JBTSR, CONSTRICTION, BCONSTRICTION)   ! SW 7/24/2018  8/5/2018
   ...
   DEALLOCATE (LATGTC, LATSPC, LATPIC, DYNPIPE, LATPUC, DYNGTC, OPT, CIND, CINSUM, CDWBC, KFWBC, CPRWBC, CINBRC, CTRTRC, &
               CDTBRC, DYNPUMP)   ! SW 5/10/10
   ...
   DEALLOCATE (SNPFN, PRFFN, SPRFN, CPLFN, VPLFN, FLXFN, FLXFN2, VPRFN, AFW, BFW, CFW, &
               WINDH, RHEVC, FETCHC, JBDN, SPRVFN)   ! SW 9/28/2018
   ...
   DEALLOCATE (CGQ10, CG0DK, CGLDK, CGKLF, CGCS, CUNIT, CUNIT1, CUNIT2, CAC, INCAC, TRCAC, DTCAC, &
               PRCAC, CNAME, CNAME1, CNAME2, CMULT) !LCJ 2/26/15
...
!  DEALLOCATE (SSFLOC, FLOCEQN)
   ...
   DEALLOCATE (SEDCC1, SEDCC2, ICEQSS, SDK1, sdk2, SEDCI1, SEDCI2, SEDPRC1, SEDPRC2, &
               SEDVP1, SEDVP2, SED1, SED2, fsedc1, fsedc2, pbiom, nbiom, cbiom, sed1ic, sed2ic, sdfirstadd)   ! cb 9/3/17
   DEALLOCATE (ISO_SEDIMENT1, VERT_SEDIMENT1, LONG_SEDIMENT1, ISO_SEDIMENT2, VERT_SEDIMENT2, LONG_SEDIMENT2, &
               PRINT_SEDIMENT1, PRINT_SEDIMENT2)
   ...
   DEALLOCATE (QSUM, NOUT, KTQIN, KBQIN, ELUH, NL, NPOINT, SLOPE, SLOPEC, ALPHA, COSA, SINA, SINAC, TDHFN, &
               QOTFN, PREFN)
   ...
   DEALLOCATE (ET1, ET2, ET3, HNAME, FMTH, KFAC, KFNAME, KFNAME2, KFCN, C2I, TRCN, CDN, CDNAME, &
               CDNAME2, CDMULT)
   ...
   DEALLOCATE (CUH, CDH, EPM, EPD, C1S, CSSB, CVP, CSSUH1, CSSUH2, CSSDH2, CSSDH1, LNAME, IWR, &
               KTWR, EKTWR, EKBWR)
