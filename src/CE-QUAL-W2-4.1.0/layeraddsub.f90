...
!**** Subtract layers
      ...
      DO WHILE (SUB_LAYER)
        ...
        WRITE (WRN,'(/1X,13("*"),1X,A,I0,A,F0.3,A,I0,1X,A,I0,1x,13("*"))') 'Subtract layer ', &
        KT,' at Julian day = ', JDAY,' NIT = ',NIT,' IZMIN =',IZMIN(JW)   
...
WRITE (W2ERR, '(A,I0/A,F0.2,2(A,I0))') 'Fatal error - insufficient segments in branch ', JB, 'Julian day = ', JDAY, &    ! SEE NEW CODE BELOW
               ...
               ELSE
                ...
                IF (SNAPSHOT(JW)) WRITE (SNP(JW), '(/1X,13("*"),1X,A,I0,A,F0.3,A,I0,1X,A,I0,13("*"))') '   Branch Inactive: ', jb, &
                     ' at Julian day = ', JDAY, '   NIT = ', NIT
            WRITE (WRN,'(/1X,13("*"),1X,A,I0,A,F0.3,A,I0,1X,A,I0,13("*"))') '   Branch Inactive: ', &
            jb,' at Julian day = ',JDAY,'   NIT = ',NIT    ! SW 11/16/2018
                  CYCLE
               ENDIF
